						...
						try {
							...
							do {
								...
								case 1:
									...
									bean1.setBookPublications(bookPublisherName);
								...
								case 3:
									...
									for (Book bookBean : bookauthor) {
										...
										if (bookBean != null) {
											...
											System.out.println("Book_PublisherName is-->"+bookBean.getBookPublications());
										} else {
								...
								case 7:
									LinkedList<Book> info = service.getBooks();
								...
								case 9:
									try {
										...
										for (User infos : userInfos) {
											...
											System.out.println("User Name -------- " + infos.getuName());
											System.out.println("User Email------ " + infos.getuEmail());
								...
								case 10:
									try {
										...
										for (RequestBean info1 : requestInfos) {
											...
											System.out.println("Book Name -------- " + info1.getBookInfo().getAuthorName());
											System.out.println("User id----------- " + info1.getUserInfo().getuId());
											System.out.println("User Name -------- " + info1.getUserInfo().getuName());
							...
							do {
								...
								case 5:
									...
									try {
										...
										System.out.println("-----------------------------------");
										System.out.println("User Id-----" + request.getUserInfo().getuId());
										System.out.println("User name---" + request.getUserInfo().getuName());
								...
								case 6:
									...
									try {
										...
										System.out.println("-----------------------------------");
										System.out.println("User Id ------"+requestInfo.getUserInfo().getuId());
